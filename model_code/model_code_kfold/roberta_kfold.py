...
def train_one_fold(train_df, val_df, test_df, fold_name: str): #ใช้สำหรับ train + evaluate โมเดลใน 1 fold
    ...
    out_dir = os.path.join("roberta_kfold_outputs", fold_name)
...
if __name__ == "__main__": 
    ...
    os.makedirs("roberta_kfold_outputs", exist_ok=True)
    results_csv = os.path.join("roberta_kfold_outputs", "roberta_kfold_result.csv")
    summary_csv = os.path.join("roberta_kfold_outputs", "roberta_kfold_summary.csv")
