...
if __name__ == "__main__": 
    ...
    os.makedirs("bart_kfold_outputs", exist_ok=True)
    results_csv = os.path.join("bart_kfold_outputs", "bart_kfold_result.csv")
    summary_csv = os.path.join("bart_kfold_outputs", "bart_kfold_summary.csv")
