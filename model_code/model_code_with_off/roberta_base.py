...
# 8) Save model
# ----------------------------
#บันทึกโมเดลที่ดีที่สุด (ตาม f1_macro) และ tokenizer ไปยังโฟลเดอร์ roberta_sentiment_3class_model
SAVE_DIR = "roberta_sentiment_3class_model"
...
OUTPUT_XLSX = "roberta_base.xlsx"
OUTPUT_CSV = "roberta_base.csv"
...
RUNTIME_CSV = "runtime_roberta_base_summary.csv"
